...
# --- CORRECTION DES CHEMINS DYNAMIQUES ---
# Path(__file__).resolve() donne le chemin complet de train.py
# .parents[2] remonte de 3 niveaux (train.py -> training_pipeline -> src -> racine du projet)
PROJECT_ROOT = Path(__file__).resolve().parents[2]

DEFAULT_TRAIN = PROJECT_ROOT / "data" / "processed" / "feature_engineered_train.csv"
DEFAULT_EVAL = PROJECT_ROOT / "data" / "processed" / "feature_engineered_eval.csv"
DEFAULT_OUT = PROJECT_ROOT / "models" / "xgb_model.pkl"
# ----------------------------------------
