...
TRAIN_PATH = PROJECT_ROOT / "data" / "processed" / "feature_engineered_train.csv"
EVAL_PATH = PROJECT_ROOT / "data" / "processed" / "feature_engineered_eval.csv"
...
def test_tune_saves_best_model(tmp_path):
    ...
    best_params, best_metrics = tune_model(
        ...
        n_trials=2,
        sample_frac=0.02,
        tracking_uri=tracking_uri,  # Passe l'URI SQLite
